...
contract CreateHodlContract {
  ...
  */
  ...
  /*
   Creates a new contract which will hold the hodl logic for the
   beneficiary
  */
  ...
  /*
    ...
    to redeem later
  */
  function getHodlContractAddress(address _beneficiary) public view returns(address, address, address, uint256, uint256, uint256) {
    ...
    uint256 releaseTime;
    uint256 balance;
    (erc20Address, beneficiary, releaseTime, balance) = hodlContract.allInfo();
    return (erc20Address, beneficiary, hodlContractAddress, releaseTime, block.timestamp, balance);
  }
  ...
  */
  ...
  /*
  all fines will be collected in this contract
  */
